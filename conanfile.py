...
class mpeg2tsConan(ConanFile):
    ...
    license = "Apache-2.0"
    homepage = "https://github.com/skullanbones/mpeg2ts"
    url = "https://github.com/TUM-CONAN/conan-mpeg3ts"
    description = "mpeg-2 transport stream media format"
    ...
    def _patch_sources(self):
        ...
        tools.replace_in_file(os.path.join(self._source_subfolder, "libs", "h264codec", "CMakeLists.txt"),
            "$<BUILD_INTERFACE:${CMAKE_SOURCE_DIR}/libs/mpeg2ts/src># For EsParser.h",
            "$<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/../mpeg2ts/src># For EsParser.h"
            )

        tools.replace_in_file(os.path.join(self._source_subfolder, "libs", "mpeg2codec", "CMakeLists.txt"),
            "$<BUILD_INTERFACE:${CMAKE_SOURCE_DIR}/libs/mpeg2ts/src># For EsParser.h",
            "$<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/../mpeg2ts/src># For EsParser.h"
            )


        tools.replace_in_file(os.path.join(self._source_subfolder, "apps", "h264parser", "CMakeLists.txt"),
        ...
        $<BUILD_INTERFACE:${CMAKE_SOURCE_DIR}/libs/h264codec/src># For H264Parser.h""",
            """$<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/../../libs/mpeg2ts/src># For TsParser.h
        $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/../../libs/mpeg2codec/src># For Mpeg2VideoParser.h
        $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/../../libs/h264codec/src># For H264Parser.h"""
            )

        tools.replace_in_file(os.path.join(self._source_subfolder, "apps", "tsparser", "CMakeLists.txt"),
            """$<BUILD_INTERFACE:${CMAKE_SOURCE_DIR}/libs/mpeg2ts/src># For TsParser.h
        $<BUILD_INTERFACE:${CMAKE_SOURCE_DIR}/libs/mpeg2codec/src># For Mpeg2VideoParser.h
        $<BUILD_INTERFACE:${CMAKE_SOURCE_DIR}/libs/h264codec/src># For H264Parser.h""",
            """$<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/../../libs/mpeg2ts/src># For TsParser.h
    ...
    def source(self):
        tools.get("https://github.com/skullanbones/mpeg2ts/archive/refs/tags/%s.tar.gz" % self.version, strip_root=True,
